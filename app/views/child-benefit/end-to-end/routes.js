...
router.post('/child-benefit/end-to-end/change-child-answer', function(request, response) {
...
router.post(
  '/child-benefit/end-to-end/one-thing-per-page/tell-us-the-other-name', 
...
router.post(
  "/child-benefit/end-to-end/nationality/add-other-nationality", 
  function(request, response) {
...
router.post(
  "/child-benefit/end-to-end/one-thing-per-page/tell-us-your-last-address", 
  function(request, response) {
...
router.post(
  "/child-benefit/end-to-end/one-thing-per-page/eldest-child-details", 
  function(request, response) {
...
router.post(
  "/child-benefit/end-to-end/one-thing-per-page/partner-eldest-child-details", 
  function(request, response) {
...
router.post(
  "/child-benefit/end-to-end/one-thing-per-page/other-country", 
  function(request, response) {
...
router.post(
  "/child-benefit/end-to-end/one-thing-per-page/deed-poll", 
  function(request, response) {
...
router.post(
  "/child-benefit/end-to-end/one-thing-per-page/system-number", 
  function(request, response) {
...
router.post(
  "/child-benefit/end-to-end/one-thing-per-page/system-number-input", 
  function(request, response) {
    if (
...
router.post("/child-benefit/end-to-end/one-thing-per-page/district-number-input", 
  function(request, response) {
    if (
...
router.post("/child-benefit/end-to-end/one-thing-per-page/registration-number-input", 
  function(request, response) {
    if (
...
router.post(
  "/child-benefit/end-to-end/one-thing-per-page/do-you-know-who-claimed", 
  function(request, response) {
    if (
...
router.post(
  "/child-benefit/end-to-end/one-thing-per-page/name-of-person-who-claimed", 
  function(request, response) {
    if (
...
router.post(
  "/child-benefit/end-to-end/one-thing-per-page/find-address-of-previous-claimant", 
  function(request, response) {
    if (
...
router.post(
  "/child-benefit/end-to-end/multiple-children/child-different-address", 
  function(request, response) {
...
router.post(
  "/child-benefit/end-to-end/multiple-children/person-child-lives-with", 
  function(request, response) {
...
router.post(
  "/child-benefit/end-to-end/multiple-children/find-address-of-person", 
  function(request, response) {
    if (
...
router.post(
  "/child-benefit/end-to-end/multiple-children/lived-with-another", 
  function(request, response) {
...
// Conditional routing for if the child has lived at a different address
router.post(
  "/child-benefit/end-to-end/multiple-children/person-child-lived-with", 
  function(request, response) {
...
router.post(
  "/child-benefit/end-to-end/multiple-children/find-address-of-person-lived-with", 
  function(request, response) {
    if (
